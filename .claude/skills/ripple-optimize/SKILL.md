...
- The Ripple API is specified at <https://qualcomm.github.io/learn-ripple/ripple-spec/api.html>. If you are unsure whether a given intrinsic exists or what it does, fetch the spec before answering — do not guess.
